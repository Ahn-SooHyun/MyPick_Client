                ...
                <form>
                  <div className="joinForm">
                    ...
                    <div className={`ham-area`}>
                      ...
                      <div
                        className={idUnqiueCheck ? "seedImg" : ""}
                    ...
                    <div className="ham-area nicknameArea">
                      ...
                      <label
                        htmlFor="NickName"
                        className={`${nickNameCheck ? "warning" : ""}`}
                      >
                        NickName 입력
                      </label>
                    </div>
